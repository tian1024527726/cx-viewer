      ...
      <ConfigProvider theme={this.themeConfig}>
        ...
        >
          <div className={styles.modalActions}>
            {this.renderLogProjectSelector(false)}
